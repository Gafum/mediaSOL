...
import { ItemsTypesArray } from "./ItemsTypesArray";
...
export const CatalogContent: IGadget[] = [
   {
      ...
      img: import.meta.env.VITE_BASE_URL + "/static/images/items/firstPC.jpg",
   ...
   },
   {
      ...
      price: 199.99,
      description:
         "Ein leistungsstarkes Tablet für Arbeit und Freizeit. Perfekt für diejenigen, die unterwegs arbeiten, Filme schauen oder Spiele spielen möchten. Mit seiner langen Akkulaufzeit, scharfen Auflösung und einer benutzerfreundlichen Oberfläche ist es eine ausgezeichnete Wahl für alle Altersgruppen.",
