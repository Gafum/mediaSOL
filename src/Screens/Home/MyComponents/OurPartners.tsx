export const OurPartners = (): JSX.Element => {
   return (
      <div className="grid gap-5 grid-cols-1 max-w-[250px] items-center justify-items-center w-full m-auto sm500:grid-cols-2 sm500:max-w-[1200px] md:grid-cols-4 md:h-[100px] md:gap-2 ">
         <img
